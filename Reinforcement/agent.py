...
class Agent:
    ...
    def get_state(self, game):
        ...
        state = [
            ...
            game.food.y < game.head.x,  #Up
            game.food.y > game.head.x,  #Down 
            ]
    ...
    def get_action(self, state):
        #do random moves: tradeoff between exploration / exploitation
...
def train():
    ...
    while True:
        ...
        if done:
            game.reset
            agent.n_games +=1
            agent.traing_long_memory(state_old, final_move, reward, state_new, done)
